! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.AOS = t() : e.AOS = t() }(this, (function() {
    return function(e) {
        ...
        (function(t) {
            ...
            function o(e, t, o) {
                function i(t) {
                    var o = f,
                        n = m;
                    return f = m = void 0, g = t, b = e.apply(n, o)
                }

                function a(e) { return g = e, v = setTimeout(s, t), x ? i(e) : b }

                function c(e) { var o = e - y; return void 0 === y || o >= t || o < 0 || O && e - g >= p }

                function s() { var e = k(); return c(e) ? d(e) : void(v = setTimeout(s, function(e) { var o = t - (e - y); return O ? w(o, p - (e - g)) : o }(e))) }

                function d(e) { return v = void 0, j && f ? i(e) : (f = m = void 0, b) }

                function l() {
                    var e = k(),
                        o = c(e);
                    if (f = arguments, m = this, y = e, o) { if (void 0 === v) return a(y); if (O) return v = setTimeout(s, t), i(y) }
                ...
                return t = r(t) || 0, n(o) && (x = !!o.leading, p = (O = "maxWait" in o) ? h(r(o.maxWait) || 0, t) : p, j = "trailing" in o ? !!o.trailing : j), l.cancel = function() { void 0 !== v && clearTimeout(v), g = 0, f = y = m = v = void 0 }, l.flush = function() { return void 0 === v ? b : d(k()) }, l
            }
            ...
            function r(e) {
                ...
                e = e.replace(d, "");
                var o = f.test(e);
                return o || m.test(e) ? p(e.slice(2), o ? 2 : 8) : l.test(e) ? c : +e
            }
        ...
        (function(t) {
            ...
            function n(e) { return "symbol" == (void 0 === e ? "undefined" : r(e)) || function(e) { return !!e && "object" == (void 0 === e ? "undefined" : r(e)) }(e) && y.call(e) == c }
            ...
            e.exports = function(e, t, n) {
                function r(t) {
                    var o = f,
                        n = m;
                    return f = m = void 0, k = t, b = e.apply(n, o)
                }

                function u(e) { return k = e, v = setTimeout(s, t), x ? r(e) : b }

                function c(e) { var o = e - y; return void 0 === y || o >= t || o < 0 || O && e - k >= p }

                function s() { var e = w(); return c(e) ? d(e) : void(v = setTimeout(s, function(e) { var o = t - (e - y); return O ? h(o, p - (e - k)) : o }(e))) }

                function d(e) { return v = void 0, j && f ? r(e) : (f = m = void 0, b) }

                function l() {
                    var e = w(),
                        o = c(e);
                    if (f = arguments, m = this, y = e, o) { if (void 0 === v) return u(y); if (O) return v = setTimeout(s, t), r(y) }
                    return void 0 === v && (v = setTimeout(s, t)), b
                }
                var f, m, p, b, v, y, k = 0,
                    x = !1,
                ...
                return t = i(t) || 0, o(n) && (x = !!n.leading, p = (O = "maxWait" in n) ? g(i(n.maxWait) || 0, t) : p, j = "trailing" in n ? !!n.trailing : j), l.cancel = function() { void 0 !== v && clearTimeout(v), k = 0, f = y = m = v = void 0 }, l.flush = function() { return void 0 === v ? b : d(w()) }, l
            }
        }).call(t, function() { return this }())
    }, function(e, t) {
        "use strict";
        ...
        function o(e) {
            var t = void 0,
                n = void 0;
            for (t = 0; t < e.length; t += 1) { if ((n = e[t]).dataset && n.dataset.aos) return !0; if (n.children && o(n.children)) return !0 }
            return !1
        }
        ...
        var n = function() {
            ...
            c = function() {
                ...
                return n(e, [{ key: "phone", value: function() { var e = o(); return !(!i.test(e) && !r.test(e.substr(0, 4))) } }, { key: "mobile", value: function() { var e = o(); return !(!a.test(e) && !u.test(e.substr(0, 4))) } }, { key: "tablet", value: function() { return this.mobile() && !this.phone() } }]), e
            }();
        t.default = new c
    }, function(e, t) {
        "use strict";
...
})), window.innerWidth < 768 && [].slice.call(document.querySelectorAll("[data-bss-disabled-mobile]")).forEach((function(e) { e.classList.remove("animated"), e.removeAttribute("data-bss-hover-animate"), e.removeAttribute("data-aos"), e.removeAttribute("data-bss-parallax-bg"), e.removeAttribute("data-bss-scroll-zoom") })), document.addEventListener("DOMContentLoaded", (function() {
        "AOS" in window && AOS.init();
        [].slice.call(document.querySelectorAll("[data-bss-hover-animate]")).forEach((function(e) { e.addEventListener("mouseenter", (function(e) { e.target.classList.add("animated", e.target.dataset.bssHoverAnimate) })), e.addEventListener("mouseleave", (function(e) { e.target.classList.remove("animated", e.target.dataset.bssHoverAnimate) })) }))
    }), !1),
    function() {
        "use strict";
        ...
        if (e) {
            ...
            if (t) {
                ...
                for (var i of n) i.addEventListener("click", (function(e) { o.hide() }))
            }
            var r = function() {
        ...
        var t = $(e.relatedTarget).index(),
            o = $(".carousel-item").length;
        if (t >= o - 4)
            for (var n = 5 - (o - t), i = 0; i < n; i++) "left" == e.direction ? $(".carousel-item").eq(i).appendTo(".carousel-inner") : $(".carousel-item").eq(0).appendTo(".carousel-inner")
